...
@Component({
  selector: 'app-hr-attendance-rules',
  templateUrl: './attendance-rules.component.html',
  styleUrls: ['./attendance-rules.component.scss']
})
export class HrAttendanceRulesComponent implements OnInit {
  ...
  openCreate(): void {
    this.router.navigate(['/hr/attendance/rules/add']);
  }

  openEdit(rule: ExtendedAttendanceRule): void {
    this.router.navigate(['/hr/attendance/rules', rule.id, 'edit']);
  }
