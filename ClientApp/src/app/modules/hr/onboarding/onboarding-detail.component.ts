...
@Component({
  selector: 'app-hr-onboarding-detail',
  templateUrl: './onboarding-detail.component.html',
  styleUrls: ['./onboarding-detail.component.scss']
})
export class HrOnboardingDetailComponent implements OnInit {
  candidateId: string = '';
  newNoteText: string = '';
  ...
  editCandidate(): void {
    this.router.navigate(['/hr/onboarding', this.candidateId || '101', 'edit']);
  }
