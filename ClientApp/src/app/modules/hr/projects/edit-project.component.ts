...
@Component({
  selector: 'app-hr-edit-project',
  template: `
    <app-page-header title="Edit Project" subtitle="Update project scope, priority, team lead assignment, and timelines" [breadcrumbs]="[{label:'Dashboard',link:'/dashboard'},{label:'Projects',link:'/hr/projects'},{label:'Edit Project'}]">
...
export class HrProjectEditComponent implements OnInit {
  projectId = '';
  departments: any[] = [];
