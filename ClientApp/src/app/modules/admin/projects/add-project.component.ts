...
@Component({
  ...
  template: `
    <app-page-header title="Create New Project" subtitle="Set project details, schedule, department allocation, and team lead" [breadcrumbs]="[{label:'Dashboard',link:'/dashboard'},{label:'Projects',link:'/admin/projects'},{label:'Add Project'}]">
...
export class AdminProjectAddComponent implements OnInit {
  departments: any[] = [];
