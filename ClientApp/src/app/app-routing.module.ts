...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'projects', canActivate: [RoleRedirectGuard], children: [], data: { feature: 'projects' } },
      { path: 'employee-management', canActivate: [RoleRedirectGuard], children: [], data: { feature: 'employee-management' } },
      { path: 'tl-management', canActivate: [RoleRedirectGuard], children: [], data: { feature: 'tl-management' } },
      { path: 'hr-management', canActivate: [RoleRedirectGuard], children: [], data: { feature: 'hr-management' } },
      { path: 'reporting-hierarchy', canActivate: [RoleRedirectGuard], children: [], data: { feature: 'reporting-hierarchy' } },
      { path: 'attendance', canActivate: [RoleRedirectGuard], children: [], data: { feature: 'attendance' } },
      { path: 'attendance/corrections', canActivate: [RoleRedirectGuard], children: [], data: { feature: 'attendance-corrections' } },
      { path: 'attendance/summary', canActivate: [RoleRedirectGuard], children: [], data: { feature: 'attendance-summary' } },
      { path: 'attendance/rules', canActivate: [RoleRedirectGuard], children: [], data: { feature: 'attendance-rules' } },
      { path: 'attendance/rules/add', canActivate: [RoleRedirectGuard], children: [], data: { feature: 'attendance-rules-add' } },
      { path: 'attendance/rules/:id/edit', canActivate: [RoleRedirectGuard], children: [], data: { feature: 'attendance-rules-edit' } },
      ...
      { path: 'payroll/salary-structures', canActivate: [RoleRedirectGuard], children: [], data: { feature: 'salary-structures' } },
      { path: 'payroll/reports', canActivate: [RoleRedirectGuard], children: [], data: { feature: 'payroll-reports' } },
      ...
      { path: 'settings/company', canActivate: [RoleRedirectGuard], children: [], data: { feature: 'company-settings' } },
      { path: 'settings/email-sms', canActivate: [RoleRedirectGuard], children: [], data: { feature: 'email-sms-config' } },
      { path: 'settings/notifications', canActivate: [RoleRedirectGuard], children: [], data: { feature: 'notification-settings' } },
      { path: 'audit-logs', canActivate: [RoleRedirectGuard], children: [], data: { feature: 'audit-logs' } },
      { path: 'admin', loadChildren: () => import('./modules/admin/admin.module').then(m => m.AdminModule), canLoad: [RoleGuard], canActivate: [RoleGuard], data: { roles: ['ADMIN'] } },
      ...
      { path: 'team/projects', canActivate: [RoleRedirectGuard], children: [], data: { feature: 'team-projects' } },
      ...
      { path: 'tl', loadChildren: () => import('./modules/team-lead/team-lead.module').then(m => m.TeamLeadModule), canLoad: [RoleGuard], canActivate: [RoleGuard], data: { roles: ['TL', 'ADMIN'] } },
      ...
      { path: 'my-projects', canActivate: [RoleRedirectGuard], children: [], data: { feature: 'my-projects' } },
      ...
      { path: 'hr', loadChildren: () => import('./modules/hr/hr.module').then(m => m.HrModule), canLoad: [RoleGuard], canActivate: [RoleGuard], data: { roles: ['HR', 'ADMIN'] } },
      { path: 'employee', loadChildren: () => import('./modules/employee/employee.module').then(m => m.EmployeeModule), canLoad: [RoleGuard], canActivate: [RoleGuard], data: { roles: ['EMPLOYEE', 'ADMIN', 'HR', 'TL'] } },
    ]
  },
  {
    path: 'unauthorized',
