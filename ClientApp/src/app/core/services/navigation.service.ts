...
export class NavigationService {
  private allNavItems: NavItem[] = [
    ...
    },
    {
      ...
      children: [
        { label: 'Job Openings', icon: 'fas fa-plus-square', routerLink: '/recruitment', queryParams: { tab: 'openings' }, module: 'recruitment' },
        { label: 'Candidates', icon: 'fas fa-user-tie', routerLink: '/recruitment', queryParams: { tab: 'candidates' }, module: 'recruitment' },
      ]
    },
    { label: 'Onboarding', icon: 'fas fa-handshake', routerLink: '/onboarding', module: 'onboarding' },
    {
      ...
      children: [
        { label: 'Reviews', icon: 'fas fa-star', routerLink: '/performance', queryParams: { tab: 'reviews' }, module: 'performance' },
        { label: 'KPIs', icon: 'fas fa-bullseye', routerLink: '/performance', queryParams: { tab: 'kpi' }, module: 'kpi' },
      ]
    },
    ...
    { label: 'Notifications', icon: 'fas fa-bell', routerLink: '/notifications', module: 'notifications' },
    {
      ...
      children: [
        { label: 'HR Reports', icon: 'fas fa-file-alt', routerLink: '/reports', queryParams: { tab: 'hr' }, module: 'reports' },
        { label: 'Attendance Reports', icon: 'fas fa-calendar-check', routerLink: '/reports', queryParams: { tab: 'attendance' }, module: 'reports' },
        { label: 'Payroll Reports', icon: 'fas fa-money-bill', routerLink: '/reports', queryParams: { tab: 'payroll' }, module: 'reports' },
      ]
    },
  ...
  private hrNavItems: NavItem[] = [
    ...
    { label: 'Payroll', icon: 'fas fa-money-check-alt', routerLink: '/payroll', module: 'payroll' },
    {
      label: 'Recruitment', icon: 'fas fa-briefcase', routerLink: '/recruitment', module: 'recruitment',
      children: [
        { label: 'Job Openings', icon: 'fas fa-plus-square', routerLink: '/recruitment', queryParams: { tab: 'jobs' }, module: 'recruitment' },
        { label: 'Candidates', icon: 'fas fa-user-tie', routerLink: '/recruitment', queryParams: { tab: 'pipeline' }, module: 'recruitment' },
        { label: 'Interviews', icon: 'fas fa-calendar-check', routerLink: '/recruitment', queryParams: { tab: 'interviews' }, module: 'recruitment' },
      ]
    },
    { label: 'Onboarding', icon: 'fas fa-handshake', routerLink: '/onboarding', module: 'onboarding' },
    { label: 'Performance', icon: 'fas fa-chart-line', routerLink: '/performance', module: 'performance' },
