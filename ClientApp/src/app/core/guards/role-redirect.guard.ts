...
export class RoleRedirectGuard implements CanActivate {
  private featureModules: Record<string, RouteMap> = {
    ...
    projects: { ADMIN: 'admin', HR: 'admin' },
    'employee-management': { ADMIN: 'admin' },
    'tl-management': { ADMIN: 'admin' },
    ...
    'reporting-hierarchy': { ADMIN: 'admin', HR: 'admin' },
    'attendance-corrections': { ADMIN: 'admin', HR: 'admin' },
    'attendance-summary': { ADMIN: 'admin', HR: 'admin' },
    'attendance-rules': { ADMIN: 'admin', HR: 'admin' },
    'salary-structures': { ADMIN: 'admin', HR: 'admin' },
    'payroll-reports': { ADMIN: 'admin', HR: 'admin' },
