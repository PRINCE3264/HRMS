...
namespace HRMAPI.Migrations
{
    ...
    [Migration("20260913071206_AddRoleIdToUserPermissions")]
    partial class AddRoleIdToUserPermissions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRMAPI.Models.Entities.AttendanceCorrection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HRMAPI.Models.Entities.AttendanceRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<bool>("AutoMarkAbsentOnNoCheckIn")
                        .HasColumnType("boolean");
                    ...
                    b.Property<TimeOnly?>("LateThresholdTime")
                        .HasPrecision(0)
                    ...
                    b.Property<decimal>("MinWorkHours")
                        .HasPrecision(5, 2)
            ...
            modelBuilder.Entity("HRMAPI.Models.Entities.CompanyProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HRMAPI.Models.Entities.Employee", b =>
                {
                    ...
                    b.Property<string>("ResignationReference")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
            ...
            modelBuilder.Entity("HRMAPI.Models.Entities.Feature", b =>
                {
                    ...
                    b.Property<bool>("IsVisibleInSidebar")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("HRMAPI.Models.Entities.NotificationPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HRMAPI.Models.Entities.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HRMAPI.Models.Entities.ProjectMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HRMAPI.Models.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HRMAPI.Models.Entities.SalaryStructure", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HRMAPI.Models.Entities.AttendanceCorrection", b =>
                {
                    ...
                    b.HasOne("HRMAPI.Models.Entities.User", "RequestedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("HRMAPI.Models.Entities.Branch", b =>
                {
                    b.HasOne("HRMAPI.Models.Entities.CompanyProfile", "Company")
                        .WithMany()
            ...
            modelBuilder.Entity("HRMAPI.Models.Entities.FeatureRole", b =>
                {
                    ...
                    b.HasOne("HRMAPI.Models.Entities.Role", "RoleRef")
                        .WithMany()
            ...
            modelBuilder.Entity("HRMAPI.Models.Entities.Project", b =>
                {
                    b.HasOne("HRMAPI.Models.Entities.Employee", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("HRMAPI.Models.Entities.ProjectMember", b =>
                {
                    ...
                    b.HasOne("HRMAPI.Models.Entities.Project", "Project")
                        .WithMany("Members")
